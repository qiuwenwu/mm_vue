				...
				<mm_grid col="1" class="space-x">
					<mm_col>
						<mm_block v-show="step == 1">
							...
							<mm_body>
								<mm_input type="number" v-model="form1.phone" :max="11" desc="请输入账户绑定的手机号码"></mm_input>
								<mm_code type="success-x" title="测试" v-model="form1.code" desc="请输入手机验证码" :func="send_msg" :btn="btn_msg"></mm_code>
							</mm_body>
						</mm_block>
