<template>
	<!-- 提现记录页面 -->
	<div class="page_calculation" id="calculation_withdraw_record">
		<!-- 页主体 -->
		<mm_bodyer>
			<!-- 外套 -->
			<mm_warp>
					...
					<mm_col>
						<mm_block>
							<mm_head class="font_small">
								<mm_title><text>总提币：{{ counts }}</text><text class="unit">btc</text></mm_title>
							</mm_head>
							<mm_body class="lr">
									...
									<mm_item v-for="(o,k) in list" :key="k">
										<mm_main>
											...
											<mm_desc class="font_warning">
												<text>-{{ $float($num(o.amount)) }}</text><text class="unit">btc</text>
											</mm_desc>
										</mm_main>
									</mm_item>
								</mm_list>
