<template>
  <!-- 订单详情页面 -->
  <mm_page class="page_mall" id="mall_order_view">
    <mm_bodyer>
      <mm_warp>
        <mm_grid col="1" class="space-x">
                ...
                <mm_list col="1" class="small">
                  ...
                  <mm_item>
                    <mm_main>
                      ...
                      <mm_desc class="font_dark">{{ state_fun(obj.state) }}</mm_desc>
                    </mm_main>
                  </mm_item>
                </mm_list>
              </mm_body>
          ...
          <mm_col>
            <mm_group>
              <mm_btn type="warning-x" class="font_small" url="/pages/mall/order_list">关闭</mm_btn>
            </mm_group>
          </mm_col>
        </mm_grid>
      </mm_warp>
